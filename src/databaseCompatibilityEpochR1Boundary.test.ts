...
describe("DATABASE-COMPATIBILITY-EPOCH-1-R1 boundaries", () => {
  ...
  it("preserves migrations 021 through 023 byte-for-byte and adds no migration 024", () => {
    ...
    expect(migrationRegistry).toContain("(1_i64..=23)");
    expect(migrationRegistry).not.toContain("024_");
  });
});
