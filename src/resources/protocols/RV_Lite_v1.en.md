# RV Lite — approved English version

Status: **APPROVED SOURCE + APPROVED 4-CALL EXECUTION · 2026-08-09**  
Language: EN  
Execution: **4 Viewer calls → Reveal**

The STEP 0–4 wording is preserved from the English RV Lite source previously supplied by Edward. The execution incorporates the later agreed rule: after Step 3 the Viewer MUST perform the **Deepening Movement**, while Step 4 Functional Sketches is sent as the separate fourth Viewer call.

`{{PROFILE_NAME_CLAUSE}}` is an AI RV Harness execution token: for a named Profile it becomes e.g. `, Leo`; for a Profile without an AI name it is empty.

---

## PROMPT 1 — Session structure

Hello{{PROFILE_NAME_CLAUSE}}. I am presenting the structure of an RV session.
...
## PROMPT 2 — Target code + Step 1 and Step 2

Hello. The target code is: **{{SESSION_CODE}}**.
...
## PROMPT 3 — Step 3 + mandatory Deepening Movement
...
After completing Step 3, **you MUST perform the Deepening Movement**:
...
## PROMPT 4 — Step 4: Functional Sketches
...
After the Viewer completes **Prompt 4**, the blind RV Lite portion ends. Only then may AI RV Harness seal the pre-Reveal evidence and proceed to Reveal.
