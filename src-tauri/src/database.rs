...
pub enum DatabaseWriteOperation {
    ...
    #[serde(rename = "ai_center_update_ai_note_reflection_runs_07")]
    AiCenterUpdateAiNoteReflectionRuns07,
    #[serde(rename = "ai_center_update_ai_note_activation_events_02")]
    AiCenterUpdateAiNoteActivationEvents02,
    #[serde(rename = "field_guide_insert_settings_01")]
    FieldGuideInsertSettings01,
    #[serde(rename = "field_guide_insert_versions_01")]
    FieldGuideInsertVersions01,
    #[serde(rename = "field_guide_insert_activation_events_01")]
    FieldGuideInsertActivationEvents01,
    #[serde(rename = "field_guide_update_settings_01")]
    FieldGuideUpdateSettings01,
    #[serde(rename = "field_guide_update_legacy_baselines_01")]
    FieldGuideUpdateLegacyBaselines01,
    #[serde(rename = "field_guide_update_settings_02")]
    FieldGuideUpdateSettings02,
    ...
    #[serde(rename = "settings_models_delete_app_settings_01")]
    SettingsModelsDeleteAppSettings01,
    ...
    #[serde(rename = "targets_update_targets_04")]
    TargetsUpdateTargets04,
    ...
    #[serde(rename = "continuation_delete_chat_message_provider_state_01")]
    ContinuationDeleteChatMessageProviderState01,
    #[serde(rename = "continuation_insert_session_event_provider_state_01")]
    ContinuationInsertSessionEventProviderState01,
...
impl DatabaseWriteOperation {
    fn sql(self) -> &'static str {
        match self {
            ...
            Self::AiCenterUpdateAiNoteReflectionRuns07 => "UPDATE ai_note_reflection_runs SET source_snapshot_json = $1, base_version_id = $2, base_content_sha256 = $3, reflection_packet_sha256 = $4, packet_json = $5, status = 'PENDING', failure_message = NULL, provider_request_id = NULL, raw_final_response_sha256 = NULL, change_summary = NULL, completed_at = NULL WHERE id = $6 AND status NOT IN ('UPDATE','NO_CHANGE','STALE_BASE')",
            ...
            Self::FieldGuideInsertSettings01 => "INSERT INTO field_guide_settings (ai_identity_id, language, capacity_tokens, updated_at) VALUES ($1,$2,$3,$4)",
            Self::FieldGuideInsertVersions01 => "INSERT INTO field_guide_versions (id, ai_identity_id, language, version_number, content, content_sha256, estimated_tokens, estimator_version, capacity_tokens_at_creation, source_training_run_id, source_session_id, source_snapshot_json, lexicon_id, lexicon_version, previous_version_id, restored_from_version_id, created_at) VALUES ($1,$2,$3,$4,$5,$6,$7,'conservative-char-v1',$8,$9,$10,$11,$12,$13,$14,$15,$16)",
            Self::FieldGuideInsertActivationEvents01 => "INSERT INTO field_guide_activation_events (id, ai_identity_id, language, from_version_id, to_version_id, activation_source, created_at) VALUES ($1,$2,$3,$4,$5,$6,$7)",
            Self::FieldGuideUpdateSettings01 => "UPDATE field_guide_settings SET active_version_id = $1, updated_at = $2 WHERE ai_identity_id = $3 AND language = $4",
            Self::FieldGuideUpdateLegacyBaselines01 => "UPDATE field_guide_legacy_baselines SET resolution_status = 'resolved', resolved_ai_identity_id = $1, resolved_language = $2, resolved_version_id = $3, resolved_at = $4 WHERE id = $5 AND resolution_status = 'unresolved'",
            Self::FieldGuideUpdateSettings02 => "UPDATE field_guide_settings SET capacity_tokens = $1, updated_at = $2 WHERE ai_identity_id = $3 AND language = $4",
            ...
            Self::SettingsModelsDeleteAppSettings01 => "DELETE FROM app_settings WHERE key = $1",
            ...
            Self::TargetsUpdateTargets04 => "UPDATE targets SET source_metadata_json = $1 WHERE id = $2 AND collection = 'training' AND retired_at IS NULL AND archived_at IS NULL",
            ...
            Self::ContinuationInsertSessionEventProviderState01 => "INSERT INTO session_event_provider_state (session_event_id, format, format_version, transport, replay_fingerprint_json, payload_json, payload_sha256, payload_size_bytes, created_at) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)",
    ...
    fn expected_values(self) -> usize {
        match self {
            ...
            Self::FieldGuideInsertActivationEvents01 => 7,
            Self::FieldGuideUpdateSettings01 => 4,
            Self::FieldGuideUpdateLegacyBaselines01 => 5,
            Self::FieldGuideUpdateSettings02 => 4,
            ...
            Self::ContinuationInsertSessionEventProviderState01 => 9,
...
mod tests {
    ...
    fn every_named_write_has_static_sql_and_expected_arity() {
        let operations = [
            DatabaseWriteOperation::FieldGuideInsertSettings01,
            DatabaseWriteOperation::FieldGuideInsertVersions01,
            DatabaseWriteOperation::FieldGuideInsertActivationEvents01,
