...
impl DatabaseWriteOperation {
    fn sql(self) -> &'static str {
        match self {
            ...
            Self::TargetsUpdateTargets04 => "UPDATE targets SET source_metadata_json = $1 WHERE id = $2 AND collection = 'training' AND archived_at IS NULL",
